                ...
                <div class="nav-side">
                    <div class="hotline pe-4">
                        ...
                        <div class="cont">
                            ...
                            <a href="Tel:"><h6>(+234) 814 829 1673</h6></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="info">
                            <div class="section-head mb-60">
                                <h6 class="color-main text-uppercase">KIKISHA TECH</h6>
                                <h2>
                                    Technology & Web <span class="fw-normal">Solutions</span>
                                </h2>
                            </div>
                            <div class="text">
                                Get more for less!!!
                                Don't we love friendships that dishes out benefits daily, well kikisha Tech wishes to be your friend while you benefit massively
            ...
            <div class="content">
                ...
                <div class="about-info">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-6">
                            <div class="info">
                                <h6 class=" wow fadeInUp slow">We can help to maintain and modernize your web infrastructure  & solve various infrastructure-specific issues a business may face.</h6>
                                <p class=" wow fadeInUp slow">KIkisha Tech is the partner of choice for many of the world’s leading  enterprises, SMEs and technology challengers. We help businesses  elevate their value through custom software development, product  design, QA and consultancy services.</p>    
                ...
                <div class="col offset-lg-1">
                    <div class="section-head mb-60">
                        ...
                        <h2 class="wow fadeInUp">
                            Perfect Web Solutions <span class="fw-normal">For Your Business</span>
                        </h2>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="service-box mb-4 wow fadeInUp" data-wow-delay="0">
                            <h5>
                                <a href="payment.php"> Web Design Consultation </a> 
                            ...
                            <div class="info">
                                <div class="text">
                                    Trust our top minds to eliminate workflow pain points, implement new web development Strategy.
                                </div>
                                <div class="tags">
                                    <a href="#">Strategy</a>
                    ...
                    <div class="col-lg-4">
                        <div class="service-box mb-4 wow fadeInUp" data-wow-delay="0.2s">
                            <h5>
                                <a href="payment.php"> Website Developemnt </a> 
                    ...
                    <div class="col-lg-4">
                        <div class="service-box mb-4 mb-md-0 wow fadeInUp" data-wow-delay="0">
                            <h5>
                                <a href="payment.php"> Graphics Design </a> 
            ...
            <div class="row justify-content-end">
                <div class="col-lg-5">
                    <div class="info">
                        ...
                        <div class="text">
                            With single subscribtion, you could get up to 15% bonus or even more(for two weeks) whenever you use our services and 25% bonus whenever you refer anyone,the more the merrier !!!
                        </div>
                        <ul>
                            ...
                            <div class="swiper-slide">
                                <div class="blog_box">
                                    ...
                                    <div class="info">
                                        ...
                                        <div class="auther">
                                            <span>
                                                <img class="auther-img" src="assets/img/testimonials/user1.jpg" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="blog_box">
                                    ...
                                    <div class="info">
                                        ...
                                        <div class="auther">
                                            <span>
                                                <img class="auther-img" src="assets/img/testimonials/user3.jpg" alt="">
                                                <small><a href="#">By Admin</a></small>
                                            </span>
                                            <span>
                                                <i class="bi bi-calendar2"></i>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <div class="contact_info text-white">
                            ...
                            <h4 class="wow fadeInUp">(+234) 814 8291673</h4>
                            <ul>
                                <li class="wow fadeInUp">
                                    <strong>Address : </strong> Warri, Delta State
                                </li>
                                <li class="wow fadeInUp">
                                    <strong>Email : </strong> techkikisha@gmail.com
                                </li>
                    ...
                    <div class="col-lg-6 offset-lg-1">
                        <form class="contact_form" action="https://smartinnovates.com/items/iteck/html/contact.php" method="post"> 
                            <div class="row gx-3">
                                <div class="col-lg-6">
        ...
        <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        <div class="foot_info">
                            ...
                            <div class="text mb-4">
                                Best Website Solutions <br> Theme for Your Busines
                            </div>
                            <ul class="mb-4">
                                <li class="d-flex">
                                ...
                                <li class="d-flex">
                                    ...
                                    <a href="#">
                                        <span>techkikisha@gmail.com</span>
                                    </a>
                                </li>
                                <li class="d-flex">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="foot">
                        <p>
                            © 2022 Copyrights by <a href="#" class="text-white text-decoration-underline">KIKISHA TECH</a> All Rights Reserved by <a href="#" class="text-white text-decoration-underline"> KIKISHA TECH </a>
                        </p>
                    </div>
                </div>
            </div>
